# Erwartung - Your electricity grid data as you expect it to be

[Documentation](https://offis-dip.github.io/erwartung/)
...
* coordinates need to be matching with adresses,
* and many more.
